...
os.chdir("/p/scratch/cjinb33/ci-bennch/jureca/userdata/vogelsang1/connectivity/master/")
import time
...
def build_network():
    ...
    if not os.path.exists("/p/scratch/cjinb33/ci-bennch/jureca/userdata/vogelsang1/connectivity/master/connections_0.dat"):
      params["presimtime"] = 0.
      params["simtime"] = 0.
      nest.message(M_INFO, 'build_network',
