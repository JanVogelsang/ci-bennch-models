...
os.chdir("/p/home/jusers/vogelsang1/shared/connectivity/master/")
import time
...
def build_network():
    ...
    if not os.path.exists("/p/home/jusers/vogelsang1/shared/connectivity/master/connections_0.dat"):
      params["presimtime"] = 0.
      params["simtime"] = 0.
      nest.message(M_INFO, 'build_network',
